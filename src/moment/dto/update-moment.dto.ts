...
export class UpdateMomentDto {
  @ApiProperty({ description: 'UUID of the category', required: false })
  @IsOptional()
  @IsUUID('4', { message: 'categoryId must be a valid UUID' })
  categoryId?: string;

  @ApiProperty({ description: 'UUID of the artist', required: false })
  @IsOptional()
  ...
  @ApiProperty({ description: 'Location of the moment', required: false })
  @IsOptional()
